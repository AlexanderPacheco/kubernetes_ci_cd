...
router.get('/all/:nickname/:carpeta', (req, res) => {
...
router.get('/eliminados/:nickname/:carpeta', (req, res) => {
...
router.get('/eliminaciondef/:nickname/:linkUnico', (req, res) => {
...
router.get('/restaurar/:nickname/:linkUnico', (req, res) => {
